...
\medskip
\noindent The work in \cite{razali2011power}, states that the Shapiro-Wilks test is the most powerful, followed by the Anderson darling test and the Kolmogorov-Smirnov test. The following sections will study how effective these tests are for GW detector data while validating this claim.
