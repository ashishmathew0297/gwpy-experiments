...
\noindent This project aimed to study the effectiveness of three statistical tests, namely the Shapiro-Wilk, Kolmogorov-Smirnov, and Anderson-Darling tests, in detecting glitches in time series data taken from the L1 detector during the O3a run. The results of our experiments conducted show that the Shapiro-Wilk test is the most effective at detecting glitches across the full frequency range of 10 Hz to 1024 Hz, followed by the Kolmogorov-Smirnov and Anderson-Darling tests. The effectiveness of these tests is highly dependent on the specific characteristics of each glitch class, including their frequency content and the amount of noise present in the signal. 
