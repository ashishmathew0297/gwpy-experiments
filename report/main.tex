...
The information obtained from GW detectors encompasses a wide range of frequencies. Due to this, it is observed that low frequency noise often domainates the data, hence hiding the high frequency components which would be indicative of a signal's presence.

\medskip
\noindent Considering example of a glitch 
