...
\medskip
\noindent Similarly, for a clean signal we notice that the whitened data does not show any significant peaks, which is verified by the  Q-transform. This indicates that the signal is, primarily stationary and hence, most probably doesn't contain a glitch.
