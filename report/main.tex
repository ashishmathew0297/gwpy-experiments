...
The reference distribution we use in this project is called a \textbf{normal distribution} or \textbf{Gaussian distribution}. This is a continuous probability distribution for a random variable where most of the data points are located around the mean, with lesser amounts of data further away. This distribution is important as it can approximate many real world phenomena, such as the distribution of heights, weights, and test scores. This distribution is also the basis for many statistical tests and methods, including the ones in this project.

\medskip
\noindent In the case of interferometer noise

\medskip
\noindent The normal distribution is symmetric about the mean and has a bell-shaped curve. The mean $\mu$ of this distribution is equal to zero, with the standard deviation $\sigma$ being equal to 1. The probability density function (PDF) of a normal distribution is given by
