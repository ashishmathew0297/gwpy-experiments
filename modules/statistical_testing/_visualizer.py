...
def display_statistic_pvalue_histogram(pvalues: pd.DataFrame) -> None:
    '''
...
def display_glitch_plots(data: pd.DataFrame) -> None:
    '''
    A function to display a sample glitch from the input dataframe generated by `generate_sample_statistics()` or `fetch_glitch_data_from_csv()`
    ...
    ax[1].plot(data['t'],data["glitch_timeseries"])
...
def display_probability_plot(sample_glitch: pd.DataFrame) -> None:
    '''
    A function to display the Q-Q/probability plot of a sample glitch from the input dataframe generated by `generate_sample_statistics()` or `fetch_glitch_data_from_csv()`
...
def display_section_statistics(data: pd.DataFrame, stat_test: Literal["Shapiro", "KS", "Anderson"]="Shapiro", section_size_seconds: float=1) -> None:
    ...
    of sections of a sample glitch from the input dataframe generated by `generate_sample_statistics()` or `fetch_glitch_data_from_csv()`
